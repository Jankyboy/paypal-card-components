...
export const HostedFields = {
  ...
  render(
    ...
    return getUccEligibility.then((eligibilityData) => {
      ...
      const configuration =
        typeof __hosted_fields__ !== "undefined"
          ? __hosted_fields__.serverConfig
      ...
      return btClient
        ...
        .then((hostedFieldsInstance) => {
          ...
          hostedFieldsInstance.getCardTypes = () => {
            return __hosted_fields__.serverConfig.fundingEligibility.card
              .vendors;
          };
